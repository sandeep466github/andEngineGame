...
public class Cloud_2_pool extends GenericPool<Cloud_2> {
	 ...
	 public Cloud_2_pool(ITextureRegion pTextureRegion , PhysicsWorld mPhysics_world,GameScene mGame_scene,Camera mCamera,ResourcesManager resource_manager) {
	 ...
	 */
	 @Override
	 protected Cloud_2 onAllocatePoolItem() {
	  return new Cloud_2(0,0,mTextureRegion,vbom , physics_world,game_scene,camera,resourceManager);
	 }
	 ...
	 */
	 @Override
	 protected void onHandleRecycleItem(final Cloud_2 pBullet) {
	 ...
	 */
	 @Override
	 protected void onHandleObtainItem(final Cloud_2 pBullet) {
	  pBullet.reset();
	 }
	}
