...
public class Cloud_1_pool extends GenericPool<Cloud_1> {
	 ...
	 public Cloud_1_pool(ITextureRegion pTextureRegion , PhysicsWorld mPhysics_world,GameScene mGame_scene,Camera mCamera,ResourcesManager resource_manager) {
	 ...
	 */
	 @Override
	 protected Cloud_1 onAllocatePoolItem() {
	  return new Cloud_1(0,0,mTextureRegion,vbom , physics_world,game_scene,camera,resourceManager);
	 }
	 ...
	 */
	 @Override
	 protected void onHandleRecycleItem(final Cloud_1 pBullet) {
	 ...
	 */
	 @Override
	 protected void onHandleObtainItem(final Cloud_1 pBullet) {
	  pBullet.reset();
	 }
	}
